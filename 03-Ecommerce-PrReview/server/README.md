...
{
  "sucess": true,
  "message": "User sucessfully loggedIn with google account"
}
```
...
```http
GET /api/products/665f1a2b3c4d5e6f78901234
```
...
```http
DELETE /api/products/delete/665f1a2b3c4d5e6f78901234
```
...
3. Create product using `POST /api/products/create` with `multipart/form-data`.
4. Fetch products using `GET /api/products`.
5. Fetch one product using `GET /api/products/:id`.
6. Update own product using `PUT /api/products/:id`.
7. Delete own product using `DELETE /api/product/delete/:id`.
